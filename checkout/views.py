...
def cache_checkout_data(request):
    ...
    before confirming payment. This allows retrieval of
    cart and user info if checkout is interrupted or needs recovery.
    """
    try:
...
def checkout(request):
    ...
    - Validating and saving order on POST
...
def checkout_success(request, order_number):
    ...
    - Save user delivery info if requested
